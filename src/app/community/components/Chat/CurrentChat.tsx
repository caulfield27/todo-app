...
export const CurrentChat = ({ setMessage, message, isMobile, isTablet }: Props) => {
  ...
  return isMobile || isTablet ? (
    createPortal(
      <div ref={msgCanvas} className={styles.chat_canvas_mobile}>
        <div className={styles.cnavas_container}>
          <div className={styles.messages_wrapper}>
            <div className={`${styles.header_container} ${styles.fixed_header}`}>
              {(isMobile || isTablet) && (
          ...
          <div className={`${styles.send_message_container} ${styles.fixed_messages_input}`}>
            <textarea
            ...
            <div className={styles.send_btn_wrapper}>
              {readyToSend && (
                <button
                  ...
                  onClick={() =>
                    handleSendMsg(currentChat, setCurrentChat, message, setMessage, socket, chats)
                  }
                >
